...
- feat: Added new config option
- fix: Avoid execute something in `Logger`
- docs: Add a example
- docs: Improve the README
- test: Add test for `logger.dart`
- refactor: Optimize the structure of `logger.dart`

[github issue]: https://github.com/myConsciousness/classic-logger.dart/issues/new
[github issues]: https://github.com/myConsciousness/classic-logger.dart/issues/new
[prs]: https://github.com/myConsciousness/classic-logger.dart/pulls
