---
name: Bug report.
about: You are creating an application with classic_logger.dart but you are noticing some strange behavior, that it throws an unexpected exception, or that it is not working according to the specifications.
title: ""
labels: "Problem: bug"
...
* classic_logger.dart version: 0.4.0
-->
